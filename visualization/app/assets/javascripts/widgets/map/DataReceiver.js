...
function DataReceiver () {
  ...
  dispatcher.subscribe("time").bind ("range_updated", function(range) {    
    var minutesBack = ((new Date).getTime()/1E3|0) - range.start;
  ...
  /** This function is executed by callback of the category listener on selection change.
   * @param data Categories object, consists of 'changed', 'checkboxes' ('state', 'counter'). */
